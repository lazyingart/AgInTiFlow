...
export const RESEARCH_SYNTHESIS_PROMPT = [
  ...
  "Use one to six concise findings relevant to the question, in the user's language. Each finding must be supported by its quoted evidence, not by memory or the title alone.",
