...
const TRANSLATIONS = {
  en: {
    ...
    helpVenice: "Pick Venice route/main models, or restore LocalLLM defaults.",
    ...
    helpProvider: "Open provider selector, or set deepseek/openai/openrouter/qwen/venice/mock.",
  ...
  ja: {
    ...
    helpVenice: "Venice の route/main モデルを選択、または LocalLLM 既定値に戻します。",
    ...
    helpProvider: "プロバイダ選択を開くか deepseek/openai/openrouter/qwen/venice/mock を設定します。",
  ...
  "zh-Hans": {
    ...
    helpVenice: "选择 Venice route/main 模型，或恢复 LocalLLM 默认值。",
    ...
    helpProvider: "打开 provider 选择器，或设置 deepseek/openai/openrouter/qwen/venice/mock。",
  ...
  "zh-Hant": {
    ...
    helpVenice: "選擇 Venice route/main 模型，或恢復 LocalLLM 預設值。",
    ...
    helpProvider: "開啟 provider 選擇器，或設定 deepseek/openai/openrouter/qwen/venice/mock。",
...
const FALLBACKS = {
  ko: {
    ...
    helpVenice: "Venice route/main 모델을 선택하거나 LocalLLM 기본값으로 복원합니다.",
    ...
    helpProvider: "provider 선택기를 열거나 deepseek/openai/openrouter/qwen/venice/mock 을 설정합니다.",
  ...
  fr: {
    ...
    helpVenice: "Choisir les modèles route/main Venice, ou restaurer les valeurs LocalLLM.",
    ...
    helpProvider: "Ouvrir le sélecteur provider, ou définir deepseek/openai/openrouter/qwen/venice/mock.",
  ...
  es: {
    ...
    helpVenice: "Elegir modelos route/main de Venice, o restaurar valores LocalLLM.",
    ...
    helpProvider: "Abrir selector provider, o configurar deepseek/openai/openrouter/qwen/venice/mock.",
  ...
  ar: {
    ...
    helpVenice: "اختيار نماذج route/main من Venice أو استعادة إعدادات LocalLLM.",
    ...
    helpProvider: "فتح محدد provider أو تعيين deepseek/openai/openrouter/qwen/venice/mock.",
  ...
  vi: {
    ...
    helpVenice: "Chọn model route/main Venice, hoặc khôi phục mặc định LocalLLM.",
    ...
    helpProvider: "Mở bộ chọn provider, hoặc đặt deepseek/openai/openrouter/qwen/venice/mock.",
  ...
  de: {
    ...
    helpVenice: "Venice route/main Modelle wählen oder LocalLLM-Standard wiederherstellen.",
    ...
    helpProvider: "Provider-Auswahl öffnen oder deepseek/openai/openrouter/qwen/venice/mock setzen.",
  ...
  ru: {
    ...
    helpVenice: "Выбрать модели Venice route/main или восстановить LocalLLM по умолчанию.",
    ...
    helpProvider: "Открыть выбор provider или задать deepseek/openai/openrouter/qwen/venice/mock.",
