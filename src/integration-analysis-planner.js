...
const UNSUPPORTED_NATIVE_HOST_TOOL_ACTION =
  /\b(?:use|call|invoke|run|execute)\s+(?:the\s+)?(?!execute_python_analysis\b|grounded_search\b|deep_research\b|compile_tex_document\b|publish_file_artifact\b)(?:(?:tmux|terminal|shell|systemd|journalctl|lsof|netstat|host|native|workstation|ps)(?:_[a-z0-9]+)+|[a-z][a-z0-9]*(?:_[a-z0-9]+)*(?:_tmux|_terminal|_shell|_systemd|_journalctl|_lsof|_netstat|_host|_native|_workstation|_pid|_pids|_processes)(?:_[a-z0-9]+)*)\b/iu;
