...
从 Web 或 CLI 使用同一个智能体工作区，支持 DeepSeek/Venice/OpenAI 路由、可见工具调用、持久会话、scouts、SCS 监督、AAPS 工作流，以及受保护的本地执行。
...
| 产品定位 | [../references/agintiflow-product-positioning.md](../references/agintiflow-product-positioning.md) |
