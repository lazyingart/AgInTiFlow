...
AgInTiFlow — локальное Web- и CLI-рабочее пространство для агентной работы с настоящими папками проектов. Оно объединяет дешевый роутинг моделей, проверяемое использование инструментов, долговечные сессии, защищенные действия с файлами/shell/браузером, опциональную генерацию изображений и структурированную супервизию больших задач.
